				...
				<div class="weui-cells weui-cells_form content-item">
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <input type="text" name="task_name" class="weui-input" id="task_name" style="width: 100%;">
                        </div>
                    </div>
                    ...
                    <div class="weui-cell weui-cell_select">
                        ...
                        <div class="weui-cell__bd">
                            <select class="weui-select" name="task_level" id="task_level" style="padding-left: 0;">
                    ...
                    <div class="weui-cell" style="display:none">
                        ...
                        <div class="weui-cell__bd">
                            <input class="weui-label" id="respo_name" name="respo_name" value ="<?php echo $_GET['respo_name'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <input type="tsxt" name="task_perc" class="weui-input" id="task_perc">
                        </div>
                    </div>
                    <div class="weui-cell weui-cell_select">
                        <div class="weui-cell__hd">
                        ...
                        <div class="weui-cell__bd">
                            <select class="weui-select" id="task_status" name="task_status" style="padding-left: 0;">
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="weui-cell__bd">
                            <input type="date" name="limit_time" class="weui-input" id="limit_time">
                        </div>
                    </div>
                    <div class="weui-cell">
                        <div class="weui-cell__hd">
                        ...
                        <div class="weui-cell__bd">
                            <input type="date" name="ctime" class="weui-input" id="ctime">
                        </div>
                    </div>
