...
<body>
  ...
  <div class="page__hd">
    <h1 class="page__title">员工签出</h1>
    <p class="page__desc"></p>
  </div>

  <div class="weui-cells__title">签出信息</div>
  <div class="weui-cells weui-cells_form">
    ...
    <div class="weui-cell">
      <div class="weui-cell__hd"><label class="weui-label">签出时间</label></div>
      <div class="weui-cell__bd"><label id="sign_time"><?php echo date('Y-m-d H:i:s');?></label></div>
    </div>
    <div class="weui-cell">
      <div class="weui-cell__hd"><label class="weui-label">签出地点</label></div>
      <div class="weui-cell__bd"><label id="sign_type">白金湾</label></div>
    </div>
  </div>
  ...
  <script src="js/office_sign_out.js"></script>
