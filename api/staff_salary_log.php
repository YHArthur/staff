...
$pension_fee = round($pension_fee * 100);
$medical_fee = round($medical_fee * 100);
$jobless_fee = round($jobless_fee * 100);
$fund_fee = round($fund_fee * 100);
$bef_tax_sum = round($bef_tax_sum * 100);
$tax_sum = round($tax_sum * 100);
